...
pub trait Trait: frame_system::Trait + pallet_assets::Trait {
	/// Because this pallet emits events, it depends on the runtime's definition of an event.
	type Event: From<Event<Self>>
		+ Into<<Self as frame_system::Trait>::Event>
		+ Into<<Self as pallet_assets::Trait>::Event>;
}
...
decl_event!(
	...
	where
		...
		Token0 = <T as pallet_assets::Trait>::AssetId,
		Token1 = <T as pallet_assets::Trait>::AssetId,
		LPToken = <T as pallet_assets::Trait>::AssetId,
		Balance = <T as pallet_assets::Trait>::Balance,
	{
		...
		Mint(Token0, Token1, LPToken),
		Burn(LPToken, Token0, Token1),
	}
);
